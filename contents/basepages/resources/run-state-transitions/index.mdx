...
![Consume and produce dataset](job_input_dataset_creation.dot.png)
...
![Consume and produce dataset failed job](job_failed_dataset_creation.dot.png)
...
![Consume and produce dataset in parent job](parent_job_succeed_dataset_creation.dot.png)
...
![Parent has failed child jobs](parent_job_component_failed_dataset_creation.dot.png)
...
![Parent has failed child jobs](parent_job_failed_dataset_creation.dot.png)

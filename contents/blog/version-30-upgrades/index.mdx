...
forget it -- no further action is required. A standard Flyway migration will 
fill the newly created tables automatically. Be advised that a brief downtime 
may occur while the migration takes place. 

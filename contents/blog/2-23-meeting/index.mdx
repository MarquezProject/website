...
If you couldn't attend the monthly community meeting last week, here's a run-down of
what you missed:
...
0.30.0.
- UI improvements: as demo'ed by Peter, Marquez now features critical path
...
in the UI (not yet, but aggregation of functions is planned), Michael R. highlighted an exciting, recently added 

...
image: ./image.svg
banner: ./banner.svg
description: How to use the API behind the Marquez lineage graph
---
...
```
In sum, when you query the API about nodes (i.e., datasets and jobs), what you get is a lineage graph!

![Marquez Graph](marquez_graph.png)
